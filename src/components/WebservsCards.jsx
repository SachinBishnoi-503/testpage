          ...
          <div className='bg-blue-card max-w-[1210px] mx-auto mb-[130px]'>
              <div className='py-[39px] px-[35px] flex justify-between items-center max-lg:flex-col '>
                  ...
                  <div className='flex-col max-lg:pt-2'>
                      <h2 className='font-Messiri font-bold max-md:text-xl  md:text-custom-xl leading-custom-2xl text-white max-w-[633px] max-lg:w-full max-lg:items-center'>Webserv’s efforts have increased mobile conversion rates and reduced ad spending by 61% and 20%, respectively.</h2>
                      <div>
